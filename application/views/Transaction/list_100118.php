		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="#" id="formTransaction" class="form-horizontal">
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input type="text" id="txtTanggal" class="form-control" name="txtTanggal" value="<?php echo date("Y-m-d");?>">
							</div>  
						</div>
						<div class="form-group">
						...
						<div class="form-group">
						 ...
						 <div class="form-group">
							...
							<div class="col-md-4">
								<input type="text" id="txtNetSales" class="form-control" name="txtNetSales">
							</div>  
						</div>
						 <div class="form-group">
							<label class="col-md-2 control-label" for="txtKeterangan">Keterangan</label>
							<div class="col-md-10">
								<select id="txtKeterangan" name="txtKeterangan" class="form-control" data-live-search="true" required>
									<option value=""> </option>
				...
				<div class="modal-footer">
					<div class="form-group">
						<div class="col-sm-1">
							<button type="button" id="btnSaveTransaction" name="submit" onclick="saveTransaction()" class="btn btn-primary">Save</button>
						</div>
					</div>
				</div>
			</div>
