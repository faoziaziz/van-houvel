            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body" style="overflow:auto">
                    <p>
						...
						<select id="ddSendDay" name="ddSendDay" class="btn btn-success" onchange="saveEmailSendDay(this.value)">
							<option value="">Hari Kirim Email</option>
							<option value="Monday" <?php echo ($dayToSend=="Monday")? "selected" : "";?> >Senin</option>
							<option value="Tuesday" <?php echo ($dayToSend=="Tuesday")? "selected" : "";?> >Selasa</option>
							<option value="Wednesday" <?php echo ($dayToSend=="Wednesday")? "selected" : "";?> >Rabu</option>
							<option value="Thursday" <?php echo ($dayToSend=="Thursday")? "selected" : "";?> >Kamis</option>
							<option value="Friday" <?php echo ($dayToSend=="Friday")? "selected" : "";?> >Jumat</option>
							<option value="Saturday" <?php echo ($dayToSend=="Saturday")? "selected" : "";?> >Sabtu</option>
							<option value="Sunday" <?php echo ($dayToSend=="Sunday")? "selected" : "";?> >Minggu</option>
						</select>
                    </p>
...
var save_method; //for save method string
	...
	/**####**/
	function saveEmailSendDay(val){
		if(val!= "" || val != null){
			$.ajax({
				url : "<?php echo site_url('Email/saveSendEmailDay')?>/"+val,
				type: "POST",
				dataType: "JSON",
				success: function(data)
				{
