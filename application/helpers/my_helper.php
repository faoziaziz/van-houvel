<?php
	...
	function cmb_activity($name,$table,$field,$pk,$selected=null,$extra=null){
		$ci =& get_instance();
		$cmb = "<select name='$name'  class='form-control dd-unique' $extra> ";
	...
	function cmb_activity3($name,$table,$field,$pk,$selected=null,$extra=null){
		$ci =& get_instance();
		$cmb = "<select name='$name' class='form-control dd-unique' $extra> ";
		$cmb .= "<option value='-' selected disabled>Pilih</option>";
		//$cmb .= "<option value='all'>Semua Tenant</option>";
	...
	function cmb_activity4($name,$table,$field,$pk,$selected=null,$extra=null){
		$ci =& get_instance();
		$cmb = "<select name='$name' class='form-control dd-unique' $extra> ";
		$cmb .= "<option value='-' selected disabled>Pilih</option>";
		//$cmb .= "<option value='all'>Semua Tenant</option>";
