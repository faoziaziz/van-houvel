...
if (!defined('PEAR_ERROR_EXCEPTION')) define('PEAR_ERROR_EXCEPTION', 32);
/**#@-*/
...
if (substr(PHP_OS, 0, 3) == 'WIN') {
	...
	if (!defined('OS_WINDOWS')) define('OS_WINDOWS', false);
    //define('OS_UNIX',    true);
	if (!defined('OS_UNIX')) define('OS_UNIX', true);
    //define('PEAR_OS',    'Unix'); // blatant assumption
	if (!defined('PEAR_OS')) define('PEAR_OS', 'Unix');
}
